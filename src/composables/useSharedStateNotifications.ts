...
import type { Config, Notification } from '@/types/notification'

export const useSharedStateNotifications = useStateEffect(() => {
...
}, { name: 'sharedStateNotifications', destroy: false })
